...
class DetalleLogin {
    ...
    factory DetalleLogin.fromJson(Map<String, dynamic> json) => DetalleLogin(
        ...
        agenda: List<Agenda>.from(json["Agenda"].map((x) => Agenda.fromJson(x))),
...
final colorValues = EnumValues({
    "#595880": ColorClass.THE_595880
});

enum Torre {
    EMPTY,
    H007_HILTON_GUATEMALA
}
...
final trackValues = EnumValues({
    "Modalidad Presencial": Track.MODALIDAD_PRESENCIAL
});
...
class Personal {
    ...
    get fullPathImg{
      if(foto != null)
        return 'https://eventos.galileo.edu${foto}';
...
class Galeria {
    ...
    get fullPathImg{
      if(ruta != null)
        return 'https://eventos.galileo.edu${ruta}';
