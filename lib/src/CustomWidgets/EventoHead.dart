...
class EventoHead extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final numFormat =
        NumberFormat.currency(locale: "es-MX", symbol: "Q", decimalDigits: 2);
              ...
              children: [
                ...
                Text(
                  DateFormat('dd/MM/yyyy')
                      .format(DateTime.parse(event.fechaini!)),
            ...
            children: [
              Container(
                  decoration: BoxDecoration(
                      ...
                      color: Colors.amber),
                  padding:
                      EdgeInsets.only(top: 6, bottom: 5, left: 8, right: 3),
                  child: Icon(
                    Icons.description,
                    size: 15.0,
                  )),
          ...
          children: [
            if (event.precio! != "0") ...{
              ...
              Row(
                children: [
                  Text(
                    numFormat.format(double.parse(event.precio!)),
